        ...
        @endif
           ...
           @if ($contract->status == 'accept' && Auth::user()->type == 'owner')
            <a href="#" data-url="{{route('contracts.copy',$contract->id)}}"
                class="btn btn-sm btn-white btn-icon-only rounded-circle ml-0" data-ajax-popup="true" data-size="lg"  data-title="{{__('Duplicate')}}" data-toggle="tooltip" data-original-title="{{__('Duplicate')}}">
