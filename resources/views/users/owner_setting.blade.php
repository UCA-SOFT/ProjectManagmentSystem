                    ...
                    <div data-href="#tabs-6" class="list-group-item">
                        <div class="media">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="mb-0 text-sm">{{ __('You can manage your Meeting setting Information.') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-href="#tabs-8" class="list-group-item">
                        <div class="media">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="mb-0 text-sm">{{ __('You can manage your telegram setting information.') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 pt-5">
                                ...
                                @else
                                    <a href="{{$logo.'logo.png'}}" target="_blank">
                                        <img src="{{$logo.'logo.png'}}" class="img_setting" />
                                    </a>
                                @endif
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 pt-5">
                                ...
                                @else
                                    <a href="{{$logo.'logo.png'}}" target="_blank">
                                        <img src="{{$logo.'logo.png'}}" id="blah1"
                                            class="img_setting" />
                                    </a>
                                @endif
                            </div>
                                ...
                                <div id="payment-gateways" class="accordion accordion-spaced">
                                    ...
                                    <div class="card">
                                        <div class="card-header py-4" id="stripe-payment" data-toggle="collapse"
                                            ...
                                            <h6 class="mb-0"><i class="far fa-credit-card mr-3"></i>{{ __('Stripe') }}
                                            </h6>
                                        </div>
