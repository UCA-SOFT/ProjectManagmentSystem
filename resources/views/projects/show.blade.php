                ...
                <div class="card-body py-3 flex-grow-1">
                    <div class="pb-3 mb-3 border-bottom">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                @if($project->image)
                                    <img src="{{$logo_path.$project->image}}" alt="{{ $project->name }}"  class="avatar rounded-circle" id="blah" title="{{ $project->name }}"  />
                                @else
                                    <img {{$project->img_image}} class="avatar rounded-circle" title="{{ $project->name }}">
                                @endif
                            </div>
                            <div class="col ml-n2">
                                <div class="progress-wrapper">
