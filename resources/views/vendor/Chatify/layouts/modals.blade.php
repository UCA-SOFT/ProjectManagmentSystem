            ...
            <form id="updateAvatar" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="app-modal-body">
                    ...
                    @if(!empty(Auth::user()->avatar))
                        <div class="avatar av-l upload-avatar-preview" style="background-image:url('{{$profile_img.'/'.Auth::user()->avatar}}');"></div>
                    @else
                        <div class="avatar av-l upload-avatar-preview" style="background-image: url('{{$profile_img.'/avatars/avatar.png'}}');"></div>
                    @endif
