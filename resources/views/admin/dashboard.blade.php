                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="flex-fill pl-3 text-limit">
                                                    ...
                                                    <div class="d-flex justify-content-between text-xs text-muted text-right mt-1">
                                                        <div>
                                                            <span class="font-weight-bold text-{{ \App\Models\Project::$status_color[$due_project->status] }}">{{ \App\Models\Project::$status[$due_project->status] }}</span>
                                                        </div>
                                                        <div>
                                            ...
                                            <a href="{{ route('projects.show',$due_project) }}" class="list-group-item list-group-item-action">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        ...
                                                        <img src="{{$logo_path.$due_project->image}}" alt="{{ $due_project->name }}"  class="avatar rounded-circle" id="blah" />
                                                        @else
                                                            <img {{ $due_project->img_image }} class="avatar rounded-circle"/>
                                                        @endif
                                                    </div>
                                                    <div class="flex-fill pl-3 text-limit">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-3 text-right">
                                                                <span class="badge badge-xs badge-{{ (\Auth::user()->checkProject($due_project->id) == 'Owner') ? 'success' : 'warning'  }}">{{ __(\Auth::user()->checkProject($due_project->id)) }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="progress progress-xs mb-0">
                                                            <div class="progress-bar bg-{{ $due_project->project_progress()['color'] }}" role="progressbar" style="width: {{ $due_project->project_progress()['percentage'] }};" aria-valuenow="{{ $due_project->project_progress()['percentage'] }}" aria-valuemin="0" aria-valuemax="100"></div>
                                                        ...
                                                        <div class="d-flex justify-content-between text-xs text-muted text-right mt-1">
                                                            <div>
                                                                <span class="font-weight-bold text-{{ \App\Models\Project::$status_color[$due_project->status] }}">{{__(\App\Models\Project::$status[$due_project->status])}}</span>
                                                            </div>
                                                            <div>
                                                                {{ $due_project->countTask(Auth::user()->id) }}
                                                            </div>
