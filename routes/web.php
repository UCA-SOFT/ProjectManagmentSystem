...
Route::get('zoommeeting/calendar', 'ZoomMeetingController@calendar')->name('zoommeeting.calendar')->middleware(['auth','XSS']);
...
Route::post('storage-settings',['as' => 'storage.setting.store','uses' =>'SettingsController@storageSettingStore'])->middleware(['auth','XSS']);
