...
class Utility extends Model
{
    ...
    public static function settingsById()
    {
        ...
        $settings = [
            ...
            "local_storage_validation" => "jpg,jpeg,png,pdf,svg,csv,xls",
    ...
    public static function getPaymentSetting($user_id = '1')
    {
        $data     = DB::table('payment_settings');
        $settings = [
            'enable_stripe' => 'off',
    ...
    public static function getComapnyPaymentSetting($user_id = '2')
    {
        $data     = DB::table('payment_settings');
        $settings = [
            'enable_stripe' => 'off',
