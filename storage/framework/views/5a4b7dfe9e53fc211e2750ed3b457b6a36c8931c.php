...
<?php if(\Auth::user()->type == 'owner' ): ?>
    <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2" data-url="<?php echo e(route('zoommeeting.create')); ?>" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Create Meeting')); ?>">
    ...
    <div class="table-responsive" >
        <table class="table align-items-center" id="myTable">
            ...
            <tbody>
                ...
                <td><?php echo e(!empty($item->projectName)?$item->projectName->name:''); ?></td>
                <?php if(\Auth::user()->type == 'owner' ): ?>
                <td> 
                    <?php if($item->client_id != '0'): ?>
                        <?php $__currentLoopData = $item->clients($item->client_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectClient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="#" class="avatar rounded-circle avatar-sm">
                                <img alt="" <?php if(!empty($users->avatar)): ?> src="<?php echo e($profile.'/'.$projectClient->avatar); ?>" <?php else: ?>  avatar="<?php echo e((!empty($projectClient)?$projectClient->name:'')); ?>" <?php endif; ?> data-original-title="<?php echo e((!empty($projectClient)?$projectClient->name:'')); ?>" data-toggle="tooltip" data-original-title="<?php echo e((!empty($projectClient)?$projectClient->name:'')); ?>" class="">
                            </a>
                ...
                <td class="text-right">
                    ...
                    <a href="#!" class="action-item " data-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?"
                     data-confirm-yes="document.getElementById('delete-form-<?php echo e($item->id); ?>').submit();">
                        <i class="fas fa-trash"></i>
                    </a>
                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['zoommeeting.destroy', $item->id],'id'=>'delete-form-'.$item->id]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\resources\views/zoommeeting/index.blade.php ENDPATH**/ ?>