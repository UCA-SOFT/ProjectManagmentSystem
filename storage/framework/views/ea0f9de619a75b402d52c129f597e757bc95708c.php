            ...
            <form id="updateAvatar" action="<?php echo e(route('avatar.update')); ?>" enctype="multipart/form-data" method="POST">
                ...
                <div class="app-modal-body">
                    ...
                    <?php if(!empty(Auth::user()->avatar)): ?>
                        <div class="avatar av-l upload-avatar-preview" style="background-image:url('<?php echo e($profile_img.'/'.Auth::user()->avatar); ?>');"></div>
                    <?php else: ?>
                        <div class="avatar av-l upload-avatar-preview" style="background-image: url('<?php echo e($profile_img.'/avatars/avatar.png'); ?>');"></div>
                    <?php endif; ?>
...
<?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\resources\views/vendor/Chatify/layouts/modals.blade.php ENDPATH**/ ?>