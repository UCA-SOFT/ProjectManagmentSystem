                    ...
                    <div data-href="#tabs-2" class="list-group-item">
                        <div class="media">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="mb-0 text-sm"><?php echo e(__('Faster checkout with saved addresses')); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\ProjectManagmentSystem\resources\views/projects/edit.blade.php ENDPATH**/ ?>