...
<?php $__env->startSection('title'); ?> <?php echo e(__('Project Detail')); ?> <?php $__env->stopSection(); ?>

<?php $__env->startSection('action-button'); ?>
<div class="d-flex align-items-center  justify-content-between">
    <div class="dropdown btn btn-sm btn-white btn-icon-only rounded-circle ml-2 m-0">
        <a href="#" onclick="saveAsPDF()" class="action-item text-dark line_height_auto" data-toggle="tooltip" title="<?php echo e(__('Download')); ?>">
...
<?php $__env->startSection('content'); ?>
  <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body table-border-style ">
                                        <div class="table-responsive" style="height: 320px !important; overflow: auto !important;">
                                <table class="table">
                                    <thead>
                                        <tr>
                                     ...
                                     <tbody>
                                       <?php $__currentLoopData = $project->milestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                           ...
                                           <td>  <span class="badge badge-pill badge-<?php echo e(\App\Models\Project::$status_color[$milestone->status]); ?>"><?php echo e(__(\App\Models\Project::$status[$milestone->status])); ?></span></td>
    ...
    <div class="mt-3 mb-3 row d-flex align-items-center justify-content-between col-12" id="show_filter">
       ...
       <button class="btn btn-white btn-sm  col-auto btn-filter apply" style="border: 1px solid #E0E6ED;" id="filter"><i class="mdi mdi-check"></i><?php echo e(__('Apply')); ?></button>

         <button class=" btn btn-white btn-sm  col-auto " style="border: 1px solid #E0E6ED;">  <a href="<?php echo e(route('project_report.export' ,$project->id)); ?>" class="btn-white">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\ProjectManagmentSystem\resources\views/project_report/show.blade.php ENDPATH**/ ?>