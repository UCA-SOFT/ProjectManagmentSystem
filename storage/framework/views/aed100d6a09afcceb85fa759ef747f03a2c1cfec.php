            ...
            <div class="card hover-shadow-lg">
                <div class="card-header border-0 pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <span class="badge badge-xs badge-<?php echo e((\Auth::user()->checkProject($project->id) == 'Owner') ? 'success' : 'warning'); ?>" data-toggle="tooltip" data-original-title="<?php echo e(__('You are ') .__(ucfirst($project->permission()))); ?>"><?php echo e(\Auth::user()->checkProject($project->id)); ?></span>
                        </div>
                    </div>
                </div>
                <div class="card-body text-center">
                    <a href="<?php echo e(route('projects.show',$project)); ?>" class="avatar rounded-circle avatar-lg hover-translate-y-n3">
                        ...
                        <img src="<?php echo e($logo_path.$project->image); ?>" alt="<?php echo e($project->name); ?>"  class="avatar avatar-xl fix_size_show_img" id="blah" />
                        <?php else: ?>

                       <img <?php echo e($project->img_image); ?> title="<?php echo e($project->name); ?>">
                        <?php endif; ?>
                    </a>
                    <h5 class="h6 my-4">
                        <a href="<?php echo e(route('projects.show',$project)); ?>"><?php echo e($project->name); ?></a> <br>
                    </h5>
...
<?php endif; ?>
<?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\ProjectManagmentSystem\resources\views/projects/grid.blade.php ENDPATH**/ ?>