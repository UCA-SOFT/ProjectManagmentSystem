...
<div class="sidenav-header d-flex align-items-center">
    <a class="navbar-brand" href="#">
        <?php if(Auth::user()->type == 'admin'): ?>
            <img src="<?php echo e($logo.'logo.png'); ?>" class="navbar-brand-img" alt="...">
        <?php else: ?>
        <?php if(Auth::user()->mode == 'light'): ?>
            <img src="<?php echo e($path_imgs.$details['dark_logo']); ?>" class="navbar-brand-img" alt="...">
        <?php else: ?>
            <img src="<?php echo e($path_imgs.$details['light_logo']); ?>" class="navbar-brand-img" alt="...">
        <?php endif; ?>
        <?php endif; ?>
   </a>
    <div class="ml-auto">
...
<div class="nav-application clearfix">
    ...
    <?php if(Auth::user()->type != 'admin'): ?>
        <a href="<?php echo e(route('projects.index')); ?>" class="btn btn-square text-sm <?php echo e(request()->is('project*') ? 'active' : ''); ?>">
            ...
            <span class="btn-inner--icon d-block pt-2"><?php echo e(__('Proyectos')); ?></span>
        </a>
        ...
        <a href="<?php echo e(route('users')); ?>" class="btn btn-square text-sm <?php echo e(request()->is('users*') ? 'active' : ''); ?>">
            ...
            <span class="btn-inner--icon d-block pt-2"><?php echo e(__('Miembros')); ?></span>
        </a>
        ...
        <a href="<?php echo e(route('task.calendar',['all'])); ?>" class="btn btn-square text-sm <?php echo e(request()->is('calendar*') ? 'active' : ''); ?>">
            ...
            <span class="btn-inner--icon d-block pt-2"><?php echo e(__('Calendario')); ?></span>
        </a>
        <a href="<?php echo e(route('timesheet.list')); ?>" class="btn btn-square text-sm <?php echo e(request()->is('timesheet-list') ? 'active' : ''); ?>">
         ...
         <?php if(Auth::user()->type != 'admin'): ?>
            ...
            <span class="btn-inner--icon d-block pt-2"><?php echo e(__('Reportes')); ?></span>
...
<?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\ProjectManagmentSystem\resources\views/partials/admin/sidebar.blade.php ENDPATH**/ ?>