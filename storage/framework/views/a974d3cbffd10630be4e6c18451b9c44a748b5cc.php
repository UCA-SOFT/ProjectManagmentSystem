    ...
    <tr>
        <th scope="row">
            <div class="media align-items-center">
                <div>
                <?php if($user->avatar): ?>
                    <img  src="<?php echo e($logo_path.$user->avatar); ?>" class="avatar rounded-circle avatar-sm" title="<?php echo e($user->name); ?>"  >
                <?php else: ?>
                ...
                <div class="media-body ml-3">
                    ...
                    <?php if(\Auth::user()->checkProject($project->id) == 'Owner' && Auth::user()->id != $user->id): ?>
                        <span class="badge badge-xs badge-<?php echo e(($user->pivot->permission == 'user' ? 'primary' : 'warning')); ?>"><?php echo e(__(ucfirst($user->pivot->permission))); ?></span>
                    <?php endif; ?>
                    <br>
...
<?php endif; ?>
<?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\ProjectManagmentSystem\resources\views/projects/users.blade.php ENDPATH**/ ?>