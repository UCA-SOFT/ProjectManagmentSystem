...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> &dash;
        <?php echo e(Utility::getValByName('header_text') ? Utility::getValByName('header_text') : config('app.name')); ?></title>
    ...
    <title><?php echo e(__('Messages')); ?> &dash;
        <?php echo e(Utility::getValByName('header_text') ? Utility::getValByName('header_text') : config('app.name')); ?>
...
<?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\ProjectManagmentSystem\resources\views/layouts/admin.blade.php ENDPATH**/ ?>