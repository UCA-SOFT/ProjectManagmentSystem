...
<?php $__env->startSection('role'); ?><?php echo e(__('You are ') .__(ucfirst($project->permission()))); ?><?php $__env->stopSection(); ?>
...
<?php $__env->startSection('action-button'); ?>
    <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
        ...
        <a href="<?php echo e(route('projects.gantt',$project->id)); ?>" class="btn btn-sm bg-white btn-icon rounded-pill ml-2">
        ...
        <?php if(isset($permissions) && (in_array('show expense',$permissions) || in_array('create expense',$permissions))): ?>
            <a href="<?php echo e(route('projects.expenses.index',$project->id)); ?>" class="btn btn-sm bg-white btn-icon rounded-pill ml-0">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <span class="h4 font-weight-bold mb-0 "><?php echo e(\App\Models\Utility::projectCurrencyFormat($project->id,$project_data['expense']['total'])); ?></span>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <span class="text-sm text-muted"><?php echo e(__('Total Budget').' : '.\App\Models\Utility::projectCurrencyFormat($project->id,$project_data['expense']['allocated'])); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <?php if($project->image): ?>
                                    <img src="<?php echo e($logo_path.$project->image); ?>" alt="<?php echo e($project->name); ?>"  class="avatar rounded-circle" id="blah" title="<?php echo e($project->name); ?>"  />
                                <?php else: ?>
                                    <img <?php echo e($project->img_image); ?> class="avatar rounded-circle" title="<?php echo e($project->name); ?>">
                                <?php endif; ?>
                            </div>
                            <div class="col ml-n2">
                                <div class="progress-wrapper">
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <div class="h6 mb-0"><?php echo e(\App\Models\Utility::getDateFormated($project->start_date)); ?></div>
                                </div>
                                <div class="col-6">
                                    <small><?php echo e(__('End date')); ?>:</small>
                                    <div class="h6 mb-0 <?php echo e((strtotime($project->end_date) < time()) ? 'text-danger' : ''); ?>"><?php echo e(\App\Models\Utility::getDateFormated($project->end_date)); ?></div>
                                </div>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <?php if(\Auth::user()->checkProject($project->id) == 'Owner'): ?>
                            <div class="col-auto">
                                <div class="actions">
                                    <a href="#" class="action-item" data-url="<?php echo e(route('invite.project.member.view', $project->id)); ?>" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Add Member')); ?>">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <?php if(isset($permissions) && in_array('create milestone',$permissions)): ?>
                            <div class="text-right">
                                <a href="#" data-url="<?php echo e(route('project.milestone',$project->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Milestone')); ?>" class="action-item">
                                    <i class="fas fa-plus"></i>
                                    <span class="d-sm-inline-block"><?php echo e(__('Add')); ?></span>
                                </a>
                            </div>
                                    ...
                                    <div class="media align-items-center">
                                        <div class="media-body">
                                            <h6 class="text-sm d-block text-limit mb-0"><?php echo e($milestone->title); ?>
                                                ...
                                                <span class=" mx-3 badge badge-pill badge-<?php echo e(\App\Models\Project::$status_color[$milestone->status]); ?>"><?php echo e(__(\App\Models\Project::$status[$milestone->status])); ?> </span><?php echo e($milestone->tasks->count().' '. __('Tasks')); ?>
                                        ...
                                        <div class="media-body text-right">
                                            <span class="text-sm ml-3" data-url="<?php echo e(route('project.milestone.show',$milestone->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e($milestone->title); ?>" data-toggle="tooltip" data-original-title="<?php echo e(__('View')); ?>">
                                                <i class="fas fa-eye"></i>
                                            </span>
                                            <?php if(in_array('edit milestone',$permissions)): ?>
                                                <span class="text-sm ml-3" data-url="<?php echo e(route('project.milestone.edit',$milestone->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Edit Milestone')); ?>" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </span>
                                            <?php endif; ?>
                                            <?php if(in_array('delete milestone',$permissions)): ?>
                                                <span class="text-sm ml-3 text-danger" data-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>" data-confirm="<?php echo e(__('Are You Sure?')); ?>|<?php echo e(__('This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="document.getElementById('delete-form-<?php echo e($milestone->id); ?>').submit();">
                                        ...
                                        <div class="px-3 py-3">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-auto actions">
                                                    ...
                                                    <a href="<?php echo e(asset(Storage::url('tasks/'.$attachment->file))); ?>" target="_blank" class="action-item" role="button">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
        ...
        <div class="card-body table-border-style row">
            ...
            ?>
                        <div class="form-check form-switch d-inline-block float-right">
                            <input type="checkbox" class="form-check-input email-template-checkbox custom_checkbox" id="email_tempalte_<?php echo e($templates_status->id); ?>" <?php if($templates_status->is_active == 1): ?> checked="checked" <?php endif; ?> type="checkbox" value="<?php echo e($templates_status->is_active == 1 ? '1' : '0'); ?>" data-url="<?php echo e(route('status.email.language', [$EmailTemplate->id , $project->id ])); ?>"/>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\resources\views/projects/show.blade.php ENDPATH**/ ?>