...
<?php $__env->startSection('action-button'); ?>
    <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
        ...
        <a href="<?php echo e(route('projects.tasks.index',$project->id)); ?>" class="btn btn-sm bg-white btn-icon rounded-pill ml-0">
            <span class="btn-inner--text text-dark"><?php echo e(__('Tareas')); ?></span>
        </a>
        ...
        <?php if(isset($permissions) && (in_array('show expense',$permissions) || in_array('create expense',$permissions))): ?>
            <a href="<?php echo e(route('projects.expenses.index',$project->id)); ?>" class="btn btn-sm bg-white btn-icon rounded-pill ml-0">
                <span class="btn-inner--text text-dark"><?php echo e(__('Costo')); ?></span>
            </a>
        <?php endif; ?>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\ProjectManagmentSystem\resources\views/projects/show.blade.php ENDPATH**/ ?>