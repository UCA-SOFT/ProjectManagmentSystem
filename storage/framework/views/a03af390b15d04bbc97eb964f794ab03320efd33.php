    ...
    <?php else: ?>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card card-stats">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h6 class="text-muted mb-1"><?php echo e(__('Total de proyectos')); ?></h6>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card card-stats">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h6 class="text-muted mb-1"><?php echo e(__('Total de tareas')); ?></h6>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card card-stats">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h6 class="text-muted mb-1"><?php echo e(__('Costo total')); ?></h6>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card card-stats">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h6 class="text-muted mb-1"><?php echo e(__('Total de Usuarios')); ?></h6>
            ...
            <div class="col-xl-12 col-md-12">
                <div class="card card-fluid">
                    <div class="card-header">
                        <h6 class="mb-0"><?php echo e(__('Vista general de las tareas')); ?></h6>
                        <small class="text-muted"><?php echo e(__('Total de tareas completadas en los últimos 7 días')); ?></small>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card card-fluid">
                    <div class="card-header">
                        <h6 class="mb-0"><?php echo e(__('Estado de proyectos')); ?></h6>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="mb-0"><?php echo e(__('Principales proyectos vencidos')); ?></h6>
                            </div>
                        </div>
                    </div>
                    
                        <div class="card-wrapper  p-3 table_scroll min-h-430 mh-430" style="overflow: auto; ">
                                            ...
                                            <a href="<?php echo e(route('projects.show',$due_project)); ?>" class="list-group-item list-group-item-action">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        ...
                                                        <img src="<?php echo e($logo_path.$due_project->image); ?>" alt="<?php echo e($due_project->name); ?>"  class="avatar rounded-circle" id="blah" />
                                                        <?php else: ?>
        ...
        <div class="row">
            <div class="col-xl-8 col-md-8">
                <div class="card card-fluid">
                    ...
                    <div class="card-wrapper  p-3  min-h-430 mh-430"  style="overflow: auto; ">
                            ...
                            <table class="table align-items-center">
                                ...
                                <?php $__currentLoopData = $home_data['due_tasks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $due_task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="budget"><?php echo e($due_task->project->name); ?></td>
                                        <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\ProjectManagmentSystem\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>