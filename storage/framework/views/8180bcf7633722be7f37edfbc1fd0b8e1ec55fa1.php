...
<?php $__env->startSection('action-button'); ?>
    ...
    <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2" data-url="<?php echo e(route('add.user.view')); ?>" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Add Member')); ?>">
        <span class="btn-inner--icon"><i class="fas fa-plus"></i></span>
    </a>
    
    <a href="<?php echo e(route('members.export')); ?>" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2" data-title="<?php echo e(__('Export Members CSV file')); ?>" data-toggle="tooltip">
        <i class="fa fa-file-excel"></i>
    </a>

    <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle" data-url="<?php echo e(route('members.file.import')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Import Members CSV file')); ?>" data-toggle="tooltip">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\ProjectManagmentSystem\resources\views/users/index.blade.php ENDPATH**/ ?>