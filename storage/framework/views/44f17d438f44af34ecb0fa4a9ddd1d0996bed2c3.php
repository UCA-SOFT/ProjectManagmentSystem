...
<?php $__env->startSection('content'); ?>
     <div class="row  display-none d-flex align-items-center justify-content-center" id="show_filter">
        ...
        <div class="input-group input-group-sm input-group-merge input-group-flush">
            ...
            <input type="text" id="project_keyword" name="name" class="form-control form-control-flush" placeholder="<?php echo e(__('Search by Name or tag')); ?>">
        </div>
    </div>
            <div class="col-auto">
        ...
        <div class=" col-auto">  
            ...
            <input class="form-control form-control-sm w-auto" type="date" id="start_date" name="start_date" value="" autocomplete="off" required="required"  placeholder="<?php echo e(__('Start Date')); ?>">
      </div>


        <div class=" col-auto">  
           
            <input class="form-control form-control-sm w-auto" type="date" id="end_date" name="end_date" value="" autocomplete="off" required="required"  placeholder="<?php echo e(__('End Date')); ?>">
      </div>


      <button class="btn btn-white btn-sm ml-2  col-auto btn-filter apply" id="filter"><i class="mdi mdi-check"></i><?php echo e(__('Apply')); ?></button>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\ProjectManagmentSystem\resources\views/project_report/index.blade.php ENDPATH**/ ?>