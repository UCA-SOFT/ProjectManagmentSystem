        ...
        <tr data-action="0">
            ...
            <td>
                <div class="avatar av-m" style="background-color: #d9efff; text-align: center;">
                    <span class="far fa-bookmark" style="font-size: 22px; color: <?php echo e($color); ?>;margin-top: 5px !important;"></span>
                </div>
            </td>
            ...
            <td style="position: relative">
                ...
                <?php if(!empty($user->avatar)): ?>
                    <div class="avatar av-m"
                         style="background-image: url('<?php echo e($logo.$user->avatar); ?>');">
                    </div>
                <?php else: ?>
                    <div class="avatar av-m"
...
<?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\resources\views/vendor/Chatify/layouts/listItem.blade.php ENDPATH**/ ?>