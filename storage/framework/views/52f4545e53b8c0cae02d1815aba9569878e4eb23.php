                    ...
                    <div class="row mb-3">
                        <div class="col-9">
                            <div class="progress-wrapper">
                                <span class="progress-label text-muted text-sm" data-toggle="tooltip" data-original-title="<?php echo e($due_task->project->name); ?>"><a href="<?php echo e(route('projects.tasks.index',$due_task->project->id)); ?>" class="text-muted"><?php echo e($due_task->name); ?></a></span>
...
<?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\resources\views/users/due_tasks.blade.php ENDPATH**/ ?>