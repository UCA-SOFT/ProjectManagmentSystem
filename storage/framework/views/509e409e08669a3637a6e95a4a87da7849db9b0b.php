...
<?php $__env->startSection('action-button'); ?>
    ...
    <?php if($currantLang != \Auth::user()->lang && $default_lang != $currantLang): ?>
        <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle" data-toggle="tooltip" data-original-title="<?php echo e(__('Delete this language')); ?>" data-confirm="<?php echo e(__('Are You Sure? | Do you want to continue?')); ?>" data-confirm-yes="document.getElementById('delete-form-<?php echo e($currantLang); ?>').submit();"><i class="fas fa-trash"></i></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Frederick\Desktop\UCA\main_file\resources\views/lang/index.blade.php ENDPATH**/ ?>